  ...
  return (
    <div>
      ...
      >
        ...
        <div className="lead">
          <p>
          Hi I'm Matthew Nolan, an entrepreneur, engineer, artist. The focus of my career is to make society more free, open, and fair by using new tech to solve old problems. I'm a <Link href={`/blog/ted-talk/`}>TED Resident alum</Link> and public speaker on the intersection of society, technology, and culture.
          </p><p>
